...
public class Lunch extends android.support.v4.app.Fragment{
	...
	public class LunchItemsAdapter extends BaseExpandableListAdapter {
		
		private String[] places = {"Crossroads", "Cafe 3", "Foothill", "Clark Kerr"};
		
		private String[][] items = {
				MainActivity.ArrayListToArray(MainActivity.menu[4]),
				MainActivity.ArrayListToArray(MainActivity.menu[5]),
				MainActivity.ArrayListToArray(MainActivity.menu[6]),
				MainActivity.ArrayListToArray(MainActivity.menu[7])
		};
		...
		public View getChildView(int arg0, int arg1, boolean arg2, View arg3,
				ViewGroup arg4) {
			TextView textView = new TextView(Lunch.this.getActivity());
